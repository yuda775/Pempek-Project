  ...
  <div class="container">
    <div class="row">
      <div class="d-flex flex-wrap justify-content-evenly align-items-center flex-wrap mb-2">
        <div class="col-lg-3 col-md-6 col-sm-6 mt-5" v-for="card in cards" :key="card.id">
          <div class="card-menu">
...
const cards = [
  {
    ...
    image: '/assets/products/lenjer.png',
  ...
  },
  {
    ...
    image: '/assets/products/kerupuk.png',
    price: 'Rp.15.000 / porsi'
  },
  {
    id: 3,
    ...
    image: '/assets/products/kemasan.png',
    price: 'Rp.15.000 / porsi'
  },
  {
    id: 4,
    ...
    image: '/assets/products/cuko.png',
    price: 'Rp.15.000 / porsi'
  },
];
</script>
