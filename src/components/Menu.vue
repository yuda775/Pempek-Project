...
@media screen and (max-width: 1199px) {
  .card-menu {
    width: 180px;
    /* Mengurangi lebar card-menu */
  }

  .card-title {
    font-size: 12px;
    /* Mengurangi ukuran font card-title */
  }

  .card-text {
    font-size: 9px;
    /* Mengurangi ukuran font card-text */
  }

  .price {
    font-size: 12px;
    /* Mengurangi ukuran font price */
  }
}
...
@media screen and (max-width: 991px) {
  .card-menu {
    width: 150px;
    /* Mengurangi lebar card-menu lebih lanjut */
  }

  .card-title {
    font-size: 10px;
    /* Mengurangi ukuran font card-title lebih lanjut */
  }

  .card-text {
    font-size: 9px;
    /* Mengurangi ukuran font card-text lebih lanjut */
  }

  .price {
    font-size: 10px;
    /* Mengurangi ukuran font price lebih lanjut */
  }
}
</style>
      ...
      cards: [
        {
          ...
          image: '../../public/products/kapalselam.png',
        ...
        },
        {
          ...
          image: '../../public/products/adaan.png',
          price: 'Rp.15.000 / porsi'
        },
        {
          id: 3,
          ...
          image: '../../public/products/kulit.png',
          price: 'Rp.15.000 / porsi'
        },
        {
          id: 4,
          ...
          image: '../../public/products/keriting.png',
          price: 'Rp.15.000 / porsi'
        },
        {
          id: 5,
          ...
          image: '../../public/products/panggang.png',
          price: 'Rp.15.000 / porsi'
        },
        {
          id: 6,
          ...
          image: '../../public/products/pempekdos.png',
          price: 'Rp.15.000 / porsi'
        },
        {
          id: 7,
          ...
          image: '../../public/products/otakotak.png',
          price: 'Rp.15.000 / porsi'
        },
        {
          id: 8,
          ...
          image: '../../public/products/tekwan.png',
          price: 'Rp.15.000 / porsi'
        },
